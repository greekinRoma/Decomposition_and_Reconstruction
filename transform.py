...
def get_args():
    ...
    parser.add_argument('--train_dir', type=str, default='image', help='directory of training input images')
    parser.add_argument('--test_dir', type=str, default='dataset', help='directory of testing input images')
    ...
    parser.add_argument('--embed_dim', type=int, default=768, help='dimension of patch embedding')
    parser.add_argument('--model_save_dir', type=str, default='save', help='path to save the trained model')
    parser.add_argument('--m', type=int, default=2, help='number of rows to divide the image into')
    parser.add_argument('--n', type=int, default=2, help='number of columns to divide the image into')
...
if __name__ == "__main__":
    ...
    scale_model = DeRemodel(patch_size=args.patch_size, num_head=args.num_head, embed_dim= args.embed_dim, m=args.m, n=args.n).cuda()
