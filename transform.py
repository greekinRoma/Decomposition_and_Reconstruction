...
def get_args():
    ...
    parser.add_argument('--m', type=int, default=128, help='number of rows to divide the image into')
    parser.add_argument('--n', type=int, default=128, help='number of columns to divide the image into')
